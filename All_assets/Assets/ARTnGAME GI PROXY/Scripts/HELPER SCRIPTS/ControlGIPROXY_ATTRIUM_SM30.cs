	...
	void Start () {
		...
		void OnGUI(){
			...
			if(GI_PROXY_script!=null){
				...
				if(GI_PROXY_POINT_script.enabled){
						if(GUI.Button(new Rect(0,445+60,200,20),ONOFF_mount+ " point light")){
							if(PointLight.gameObject.transform.root.gameObject == Procedural_sphere.gameObject){
				...
				if(Tentacles!=null){
						...
						if(GUI.Button(new Rect(0,425+60,200,20),"Toggle Tentacles")){
					...
					if(GUI.Button(new Rect(0,465+60,200,20),"Toggle Quality")){
					...
					if(GUI.Button(new Rect(0,485+60,200,20),"Toggle Atrium")){
